...
INSERT INTO reviews(series_id, reviewer_id, rating) VALUES
    ...
    -- Scenario: User viewing a series webpage. 
    -- There the user can rate the series
    -- INSERT INTO reviews(rating, series_id, reviewer_id)alter
    -- VALUES()
...
ON series.id = reviews.series_id GROUP BY series.id
ORDER BY AVG(rating) ASC;
    
SELECT first_name, last_name, rating FROM reviewers JOIN reviews
ON reviewers.id = reviews.reviewer_id;    
    
SELECT title AS 'unreviewed series' FROM series LEFT JOIN reviews 
ON series.id = reviews.series_id
...
ON series.id = reviews.series_id AND reviewers.id = reviews.reviewer_id
